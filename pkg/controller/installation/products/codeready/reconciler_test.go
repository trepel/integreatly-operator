	...
	scenarios := []struct {
	...
	}{
		{
			...
			FakeMPM: &marketplace.MarketplaceInterfaceMock{
				...
				GetSubscriptionInstallPlanFunc: func(ctx context.Context, subName string, ns string) (plan *operatorsv1alpha1.InstallPlan, subscription *operatorsv1alpha1.Subscription, e error) {
