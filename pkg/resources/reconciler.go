...
func (r *Reconciler) ReconcileNamespace(ctx context.Context, namespace string, inst *v1alpha1.Installation, client pkgclient.Client) (v1alpha1.StatusPhase, error) {
	...
	fmt.Println(" ReconcileNamespace ", ns)
...
func (r *Reconciler) ReconcileSubscription(ctx context.Context, subscriptionName, namespace string, client pkgclient.Client) (v1alpha1.StatusPhase, error) {
	...
	ip, sub, err := r.mpm.GetSubscriptionInstallPlan(ctx, subscriptionName, namespace)
	if err != nil {
	...
	logrus.Infof("fuse online install plan is complete. Installation ready ")
	return v1alpha1.PhaseNone, nil
}
